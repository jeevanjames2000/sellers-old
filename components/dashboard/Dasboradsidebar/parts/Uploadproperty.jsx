        ...
        <div className="bg-[#FFFFFF] p-4 pt-9 rounded-md">
            <div className="flex gap-4">
                ...
                <div className="w-[62%] space-y-2">
                    <p className="text-[16px] 2xl:text-[20px] 3xl:text-[22px] 4xl:text[24px] font-[700] text-[#6d6c6c]">Upload Property</p>
                    ...
                    <Link href="/addproperty"
                        className="flex justify-end items-center text-[#699BA0] ml-auto h-7 2xl:h-8 3xl:h-9 4xl:h-10 py-1 text-[11px] 2xl:text-[16px] 3xl:text-[18px] 4xl:text[20px] font-[700] rounded-md focus:outline-none bg-transparent"
                    >
                        Add property
